...
?>
		...
		<ul  class="people"><div id="people"></div>+</ul>
		...
		<script language="JavaScript" type="text/javascript">
			...
			//Gets the browser pecific XmlHttpRequest Object
			...
			function handleReceiveChat() {
				...
				if (receiveReq.readyState == 4) {
					...
					if(n_messages-mymessages > 0 && visited == 1){
						audio.play();
			...
			function getUsers() {
				if (receiveUser.readyState == 4 || receiveUser.readyState == 0) {
					receiveUser.open("GET", 'getusers.php' , true);
					receiveUser.onreadystatechange = handleReceiveUsers;
			...
			function handleReceiveUsers() {
				if (receiveUser.readyState == 4) {
					...
					var testusers = document.getElementById("people");
					testusers.innerHTML = '';
					for (i = 0; i < n_messages; i++) {
						...
						var temp = document.createElement("li");
						temp.setAttribute("class","person");
						var timg = document.createElement("img");
						timg.setAttribute("src","icon.jpg");
						temp.appendChild(timg);
						var tspan = document.createElement("span");
						var tspan1 = document.createElement("span");
						var tspan2 = document.createElement("span");
						tspan.setAttribute("class","name");
						tspan.innerHTML += user_node[0].firstChild.nodeValue;
						temp.appendChild(tspan);
						tspan1.setAttribute("class","time");
						tspan1.innerHTML += "2:0";
						temp.appendChild(tspan1);
						tspan2.innerHTML += "hi";
						tspan2.setAttribute("class","preview");
						temp.appendChild(tspan2);
						testusers.appendChild(temp);
						
						
					}
					numusers = n_messages;					

					mTimer = setTimeout('getUsers();',5000); //Refresh our chat in 2 seconds
				}
			}
			//This functions handles when the user presses enter.  Instead of submitting the form, we
			//send a new message to the server and return false.
